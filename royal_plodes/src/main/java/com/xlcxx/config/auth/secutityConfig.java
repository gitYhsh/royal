package com.plodes.config.auth;

import com.plodes.config.auth.damain.SecurityProperties;
import com.plodes.config.auth.exceptHandler.DeniedHandler;
import com.plodes.config.auth.exceptHandler.FailureHandler;
import com.plodes.config.auth.exceptHandler.SuccessHandler;
import com.plodes.config.auth.imageCode.img.ImageCodeFilter;
import com.plodes.config.auth.services.MyUserDetailService;
import com.plodes.config.auth.session.ExpiredSession;
import com.plodes.config.auth.session.InvalidSession;
import com.plodes.config.auth.session.LogoutSuccess;
import com.plodes.config.auth.session.Logout;
...
public class secutityConfig  extends WebSecurityConfigurerAdapter {
	...
	/**用户信息**/
	@Autowired
	private MyUserDetailService authonUserDetails;
